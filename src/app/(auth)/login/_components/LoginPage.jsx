...
export default function LoginPage({ inviteToken }) {
    return (
        ...
        >
            ...
            >
                <Box sx={{ width: 180, height: 90, mb: 1, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <Image
                        src="/logo.png"
                        width={180}
                        height={90}
                ...
                <Box sx={{ textAlign: 'center', color: 'black', fontSize: 15, mb: 1 }}>
                    <Typography
                        variant="h5"
                        sx={{
                            fontWeight: 800,
            ...
            >
                <span style={{ fontWeight: 500, fontSize: 15, color: 'gray' }}>Made by Broccly</span>
                <Image
                    src="/broccly.png"
                    width={32}
                    height={32}
